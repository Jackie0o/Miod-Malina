 ...
 */
    ...
    (() => {
        ...
        let heroSlider;
        let udogodnieniaSlider;
        function initSliders() {
            if (window.innerWidth > 767.98) {
                if (!udogodnieniaSlider && document.querySelector(".udogodnienia__slider")) udogodnieniaSlider = new Swiper(".udogodnienia__slider", {
                    ...
                    navigation: {
                        prevEl: ".udogodnienia__swiper-buttons .swiper-button-prev",
                        nextEl: ".udogodnienia__swiper-buttons .swiper-button-next"
                    }
                });
            } else if (udogodnieniaSlider) {
                udogodnieniaSlider.destroy(true, true);
                udogodnieniaSlider = null;
            }
            setTimeout((() => {
                if (document.querySelector(".hero__slider") && !heroSlider) heroSlider = new Swiper(".hero__slider", {
...
***************************************************************************** */
        ...
        const galleries = document.querySelectorAll(".udogodnienia__wrapper");
        if (galleries.length) {
            let galleyItems = [];
            galleries.forEach((gallery => {
                const galleryInstance = lightgallery_es5(gallery, {
                    selector: ".udogodnienia__img",
